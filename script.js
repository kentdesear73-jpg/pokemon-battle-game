// ======================== TEAM BATTLE - 3 ATTACKS + HEAL ========================
// You choose 3 Pokémon, fight 3 enemies. Switch Pokémon, type advantages.
// Heal restores up to 30 HP (cannot exceed max HP).
...
function playerAction(action) {
    ...
    if (action === "heal") {
        ...
        // attack1, attack2, or attack3
        const attackKey = `a${action}`; // action is 1,2,3
...
renderTeamSelection();
addLog("Choose 3 Pokemon to form your team.");// ======================== TEAM BATTLE - 3 ATTACKS + HEAL ========================
// You choose 3 Pokémon, fight 3 enemies. Switch Pokémon, type advantages.
// Heal restores up to 30 HP (cannot exceed max HP).
// After defeating all 3 enemies, shows victory message.
